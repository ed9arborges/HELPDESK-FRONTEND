...
export const AuthSectionContainerVariants = cva("border border-gray-500 rounded-[0.625rem] p-7 md:min-w-100",{
  variants: {
    variant: {
      base: "",
    },
  ...
  return (
    ...
    >
      <div className="flex flex-col items-start gap-1 pl-0 pb-8">
        {title && <Text as="h1" variant="text-lg-bold">
          {title}
        </Text>}
        {description && <Text as="p" variant="text-xs">
          {description}
        </Text>}
      </div>
      {children}
